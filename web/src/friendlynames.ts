...
export default function friendlyNames(): { [key: string]: string } {
  return {
    ...
    power_line_underground: t('names.power.line-underground', 'Underground power line'),
    power_line_case: t('names.power.line-underground', 'Underground power line'),
    power_line_label: t('names.power.line-label', 'Power line'),
