// This is copied from the @protomaps/basemaps package as it isn't currently exported.
// See: https://github.com/protomaps/basemaps/pull/431
...
export function get_multiline_name(lang: string, script?: string, regular?: string) {
  ...
  const result = [
    ...
    [
      ...
      [
        'format',
        ['coalesce', ['get', `${name_prefix}name:${lang}`], ['get', 'pgf:name'], ['get', 'name']],
        get_font_formatting(_script)
      ]
    ],
    [
    ...
    [
      ...
      [
        ...
        [
          'format',
          ['coalesce', ['get', `${name_prefix}name:${lang}`], ['get', 'pgf:name2'], ['get', 'name2']],
          get_font_formatting(_script),
          '\n',
          {},
          ...get_name_block('name')
    ...
    [
      ...
      [
        ...
        [
          'format',
          ['coalesce', ['get', `${name_prefix}name:${lang}`], ['get', 'pgf:name3'], ['get', 'name3']],
          get_font_formatting(_script),
          '\n',
          {},
          ...get_name_block('name'),
